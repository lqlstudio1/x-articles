...
改写“人真正变老是停止接收新信息、停止接受变化”观点内容，产出适合 X 发布的 AI 时代认知更新/人格化补充文章包，并生成配套标题图、正文配图、资料边界和可复用脚本。

### 已完成

- 新增专题目录：`2026-07-02/stay-young-information-change/`。
- 完成正式文章：`article.md`。
- 完成 140 字以内短版，当前 101 字。
- 完成 Thread 拆条版，当前 12 条。
- 完成资料边界说明：`source-notes.md`。
- 完成标题图和 3 张正文配图：
  - `assets/01-title-5x2.png`
  - `assets/02-old-house-loop.png`
  - `assets/03-change-interaction.png`
  - `assets/04-update-system.png`
- 完成配图说明：`image-guide.md`。
- 完成可复用配图生成脚本：`tools/render_stay_young_cards.py`。
...
- 已检查短版字数为 101 字。
- 已检查正文中已标出标题图和 3 张正文配图插入位置。
- 已目检标题图和正文图，确认非空白、主标题清晰，并包含老宅、新信息流、交互循环、AI 更新系统等场景锚点。
- 已将原文末尾容易对象化的“抱年轻人/外貌身材”表达，改写为“靠近高信息密度、行动速度快、能把新东西做成作品的人”。

### 剩余风险

- 本篇属于认知更新和人格化观点内容，不是工具实测；适合穿插发布，不宜连续偏离 AI 编程/自动化主线。
- “年轻/变老”容易引发代际争议，发布时应强调核心是信息更新能力，不是年龄歧视。

## 2026-07-02

### 范围

改写“分享 6 个旺自己的方法”短内容，产出适合 X 发布的个人成长/生活方式补充文章包，并生成配套标题图、正文配图、资料边界和可复用脚本。

### 已完成

- 新增专题目录：`2026-07-02/self-energy-six-methods/`。
- 完成正式文章：`article.md`。
- 完成 140 字以内短版，当前 86 字。
- 完成 Thread 拆条版，当前 9 条。
- 完成资料边界说明：`source-notes.md`。
- 完成标题图和 3 张正文配图：
  - `assets/01-title-5x2.png`
  - `assets/02-six-habits-map.png`
  - `assets/03-let-go-past.png`
  - `assets/04-kindness-boundary.png`
- 完成配图说明：`image-guide.md`。
- 完成可复用配图生成脚本：`tools/render_self_energy_cards.py`。
- 更新 `README.md`、`knowledge_map.md` 和 `daily_task.md`。
...
- 已检查短版字数为 86 字。
- 已检查正文中已标出标题图和 3 张正文配图插入位置。
- 已目检标题图和正文图，确认非空白、主标题清晰，并包含清晨餐桌、手账、手机、植物、旧事归档盒和心形护盾等场景锚点。

### 剩余风险

- 本篇偏个人成长和生活方式，不属于账号主线 AI 编程/自动化内容；适合作为人格化补充内容，不宜连续多篇偏离主线。
- 本文不是心理咨询或医学建议，涉及长期失眠、焦虑、抑郁或严重关系创伤时应寻求专业支持。

## 2026-07-02

### 范围

改写“2026 年跟踪上百个 AI 赚钱案例，能跑通的 6 条路”专题，产出适合 X 发布的文章包，并生成配套标题图、正文配图、资料边界和可复用脚本。

### 已完成

- 新增专题目录：`2026-07-02/ai-money-six-paths-2026/`。
- 完成正式文章：`article.md`。
- 完成 140 字以内短版，当前 94 字。
- 完成 Thread 拆条版，当前 12 条。
- 完成资料边界说明：`source-notes.md`。
- 完成标题图和 3 张正文配图：
  - `assets/01-title-5x2.png`
  - `assets/02-six-paths-map.png`
  - `assets/03-delivery-filter.png`
  - `assets/04-programmer-priority.png`
- 完成配图说明：`image-guide.md`。
- 完成可复用配图生成脚本：`tools/render_ai_money_cards.py`。
- 更新 `README.md`、`knowledge_map.md` 和 `daily_task.md`。
...
- 已检查 3 张正文配图尺寸均为 1600x900。
- 已检查短版字数为 94 字。
- 已目检标题图和正文图，确认非空白、主标题清晰，并包含工作台、路径卡、交付过滤器、自动化面板等场景锚点。
- 本文未联网搜索，已在 `source-notes.md` 说明为用户提供材料改写，原始案例和收益数字未独立核验。

### 剩余风险

- AI 副业和变现内容容易被误读为收益承诺，发布时应保留“不是稳赚路线”“先跑通小交付”的边界表达。
- 如后续要强调真实案例或价格区间，需要单独联网核验并补充来源说明。
